...
社区先知围绕 **知·报·议·督** 四个板块运行。

- 🧑 **居民端**：感知社区动态 → 接诉即办 → 提案讨论 → 数据监督
- 🦺 **网格员端**：网格员工作台 → 工单管理 → 提案回复 → 内容发布
...
💡 **在对话页输入「社区脉搏」**，系统会为你展示以上所有信息。
    ...
    {
        "id": "resident_report",
        "title": "🔧 第3幕：接诉即办 — OODA 闭环核心",
        "body": """
**发现问题 → 自动上报 → 追踪进度。**

试试在对话框中输入：**「社区助餐点空调不制冷了」**
...
💡 这就是 OODA 的 **报** 环节。
        ...
        "auto_advance": False,
        "suggested_input": "社区助餐点空调不制冷了",
    },
    {
        "id": "transparency",
        "title": "📊 第4幕：社区治理看板 — 数据的力量",
        "body": """
**切换到「📊 社区治理看板」页面。**
...
| 📊 **社区治理看板** | 多维健康度 + 趋势分析 | Altair + SQLite |
