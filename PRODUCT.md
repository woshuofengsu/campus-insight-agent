...
- **教师/职工（Teacher/Staff）**：管理工作台查看全局 KPI、处理工单（分派、标记解决）、回复提案、发布通知和校园内容、查看 AI 数据洞察和周报
...
1. **治理闭环而非聊天**：每个功能服务于「发现→上报→处理→反馈」闭环，不堆砌 AI 噱头
2. **AI 是手段不是目的**：Agent 推理链可视化，让评委看到技术深度而非黑盒
