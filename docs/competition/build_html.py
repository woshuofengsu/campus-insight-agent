...
TASKS = [
    ...
    (os.path.join(BASE, "诚信声明-提交版.md"), "社区先知 · 诚信与知识产权合规声明"),
    (os.path.join(BASE, "评委评审报告.md"), "社区先知 · 五维自查报告（模拟评委）"),
    # 现场用（打印/提词）：路演包 + 逐字稿 + 作战手册
    (os.path.join(BASE, "9月22日路演包-定稿.md"), "社区先知 · 9·22 路演包（定稿）"),
